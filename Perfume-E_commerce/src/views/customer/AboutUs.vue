  ...
  <div class="flex flex-col min-h-screen overflow-hidden bg-white">
    ...
    <section
      ...
      <div class="relative z-10 text-center px-10 py-12 max-w-3xl">
        ...
        <p class="luxurious-roman-regular text-black font-light text-lg lg:text-xl leading-relaxed">
          At Scent Haven, we believe that perfumes are more than just scents.
          They are expressions of individuality and style. Our passion for
          exquisite fragrances inspires us to curate collections that capture
    ...
    <section class="w-full py-20 bg-white flex justify-center px-6">
      <div class="max-w-3xl text-center space-y-6">
        ...
        <p class="luxurious-roman-regular font-light text-back text-lg lg:text-xl leading-relaxed">
          Scent Haven Perfumes was founded by a group of fragrance enthusiasts
          with a shared vision to create a haven for perfume lovers seeking
          authentic, locally inspired fragrances. Inspired by cultural richness
          across the world, our journey is rooted in celebrating tradition,
    ...
    <section class="w-full py-20 bg-white flex flex-col items-center px-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-6xl">
        ...
        <div class=" space-y-4">
          ...
          <p class="luxurious-roman-regular font-light text-black text-lg leading-relaxed">
        ...
        <div class=" space-y-4">
          ...
          <p class="luxurious-roman-regular font-light text-black text-lg leading-relaxed">
            We believe that the key to an extraordinary scent lies in the quality of ingredients. That's why we collaborate with expert perfumes who source the finest and ethically sourced materials from around the world. We never compromise on the quality of our products, ensuring along lasting and luxurious experience.
          </p>
        </div>
        ...
        <div class=" space-y-4">
          ...
          <p class="luxurious-roman-regular font-light text-black text-lg leading-relaxed">
            Our perfumes are meticulously crafted to reflex the culture heritage, traditions, and landscapes of various regions. From the vibrant streets of Marrakech to the serene cheery blossom gardens of Kyoto, each fragrance tells a unique story that resonates with its origin.
          </p>
        </div>
    ...
    <div class=" w-full text-left self-start pl-4 lg:pl-8">
      <p class="luxurious-roman-regular font-light text-black text-lg leading-relaxed mt-10  ">
      ...
      <p class="luxurious-roman-regular font-light text-black text-lg mt-4">
