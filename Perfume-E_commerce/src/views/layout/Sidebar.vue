    ...
    <div class="flex flex-col h-full">
      ...
      <nav class="flex-1 overflow-y-auto py-2">
        <ul class="px-3 space-y-1">
          <div class="text-xs font-bold text-gray-400 uppercase tracking-wider mb-3 mt-2 px-2">
            Main Menu
          </div>
          ...
          <div class="text-xs font-bold text-gray-400 uppercase tracking-wider mb-3 mt-6 px-2">
            Settings
          </div>
          <ListSidebar
      ...
      <div class="p-4 border-t border-gray-200 bg-gray-50">
        <div class="flex items-center gap-3 mb-3">
          ...
          <div class="flex-1 min-w-0">
            ...
            <p class="text-xs text-gray-500 truncate" :title="adminProfile.email">
              {{ adminProfile.email }}
            </p>
          </div>
        </div>
        ...
        <RouterLink
          to="/"
          class="flex items-center justify-center w-full px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition shadow-sm"
        >
          View Storefront
        </RouterLink>
      </div>
