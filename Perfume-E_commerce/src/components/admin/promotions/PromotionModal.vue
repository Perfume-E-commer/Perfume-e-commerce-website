    ...
    if (newVal) {
      if (props.editData) {
        ...
        formData.value = {
          ...
          validFrom: props.editData.validFrom
            ? new Date(props.editData.validFrom).toISOString().split('T')[0]
            : '',
          validUntil: props.editData.validUntil
            ? new Date(props.editData.validUntil).toISOString().split('T')[0]
            : '',
