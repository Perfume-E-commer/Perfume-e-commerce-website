<template>
  <div class="mt-6 mb-6">
    ...
    <div
      class="flex items-center gap-2 text-sm text-gray-600 bg-white p-2 rounded-lg border border-gray-200 w-fit"
    >
      <svg
        v-if="isCreditCard"
      ...
      >
        <path
          d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2zm0 4v10h16V8H4z"
        ></path>
      </svg>
...
const displayText = computed(() => {
  if (isCreditCard.value) return 'Credit Card'
