<template>
  ...
  >
    <div
      class="bg-white rounded-2xl shadow-xl w-full max-w-4xl overflow-hidden animate-fade-in flex flex-col max-h-[90vh]"
    >
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div class="space-y-6">
            <div class="bg-gray-50 p-5 rounded-xl border border-gray-100">
              ...
              <div class="space-y-3 text-sm">
                ...
                <div>
                  ...
                  <span
                    :class="
                      customer?.active ? 'text-green-600 bg-green-50' : 'text-gray-600 bg-gray-100'
                    "
            ...
            <div class="bg-indigo-50 p-5 rounded-xl border border-indigo-100">
              <h3 class="text-xs font-bold text-indigo-400 uppercase tracking-wider mb-4">
                Lifetime Value
              </h3>
          ...
          <div class="lg:col-span-2">
            ...
            <div v-else class="space-y-3">
              ...
              >
                <div class="flex items-center gap-4">
                  <div
                    class="p-2 bg-gray-50 rounded-lg text-gray-400 group-hover:text-indigo-500 transition-colors"
                  >
