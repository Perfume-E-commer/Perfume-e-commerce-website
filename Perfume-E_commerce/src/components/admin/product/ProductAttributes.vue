  ...
  <div class="space-y-8">
    <div class="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
      <div class="flex justify-between items-center mb-4">
        <div>
          ...
          <p class="text-sm text-gray-500">
            Define the Top, Heart, and Base notes with visual representations.
          </p>
        </div>
        <button
          @click="addScentNote"
      ...
      <div class="space-y-4">
        ...
        >
          ...
          <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <div class="md:col-span-5 flex gap-4 items-center">
              <div
                class="h-16 w-16 flex-shrink-0 bg-white rounded-lg border border-gray-200 overflow-hidden flex items-center justify-center"
              >
              ...
              <div class="flex-1">
                ...
                <div v-else class="relative">
                  ...
                  <span
                    ...
                    class="absolute right-0 top-0 text-[10px] text-indigo-600 font-medium"
                    >Uploading...</span
                  >
                </div>
              </div>
        ...
        <div
          v-if="modelValue.scentNotes.length === 0"
