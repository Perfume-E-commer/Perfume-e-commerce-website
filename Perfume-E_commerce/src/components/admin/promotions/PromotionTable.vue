      ...
      <table class="w-full text-left text-sm">
        ...
        <tbody class="divide-y divide-gray-100">
          ...
          >
            ...
            <td class="px-6 py-4">
              <div class="flex items-center gap-2">
                <span class="font-mono font-bold text-indigo-700 bg-indigo-50 border border-indigo-100 px-3 py-1.5 rounded-lg text-sm select-all shadow-sm">
                  {{ promo.code }}
                </span>
                <span 
            ...
            <td class="px-6 py-4 text-center">
              <span class="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-bold bg-gradient-to-r from-purple-50 to-pink-50 text-purple-700 border border-purple-100 shadow-sm">
              ...
              <div class="flex flex-col items-center">
                ...
                >
                  <span class="flex items-center gap-1.5">
                    <span 
                      :class="promo.active && !isExpired(promo.validUntil) ? 'bg-emerald-500' : 'bg-gray-400'"
                      class="w-2 h-2 rounded-full"
                    ></span>
                    {{ getStatusText(promo) }}
                  </span>
                </button>
                <p v-if="isExpired(promo.validUntil) && promo.active" class="text-xs text-gray-400 mt-1">
                  Auto-expired
                </p>
              </div>
            </td>
